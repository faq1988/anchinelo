...
<div class="col-lg-2">
<div class="box">
  <a href="<?=base_url()?>Welcome/nuevo_cliente" type="button" class="btn btn-block btn-primary">
               ...
               <?php
                ...
                <tr>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo base_url() ?>Welcome/editar_cliente/<?php echo $clientes[$i]['id']; ?>">Editar</a></li>
                    <li><a href="<?php echo base_url() ?>Cheque/eliminar_cliente/<?php echo $clientes[$i]['id']; ?>">Eliminar</a></li>
                  </ul>
                </div>
                </td>
