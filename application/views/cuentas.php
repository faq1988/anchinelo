  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-truck"></i> Transporte JYG</a></li>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr onclick="window.location = 'http://ubuntu.com'">
                  ...
                  <td>
                      <a href="<?php echo base_url() ?>Cheque/eliminar_cuenta/<?php echo $cuentas[$i]['id']; ?>"> <i title="Eliminar" class="fa fa-fw fa-trash-o"></i></a>
