  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Editar cheque de terceros</li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Editar cheque de terceros</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <!--form role="form"-->
            <?php echo form_open('Cheque/editar_cheque_terceros/' . $cheque[0]['id']); ?>
              <div class="box-body">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-4">
                            ...
                            <div class="input-group date">
                              ...
                              value="<?php echo $cheque[0]['fecha_ingreso']; ?>">                  
                            </div>
                  ...
                  <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <div class="input-group date">
                                ...
                                value="<?php echo $cheque[0]['fecha_deposito']; ?>">
                              </div>
                  ...
                  <select name="banco_emision" class="form-control">                      
                    <option value="<?php echo set_value('banco_emision'); ?>">Seleccionar banco</option>
                            <?php
                              ...
                              <option value="<?php echo $cheque[0]['banco_emision'];?>"
                                <?php if($bancos[$i]['id']==$cheque[0]['banco_emision']) echo 'selected="selected"'; ?>>
               ...
               <select name="cliente" class="form-control">                      
                    <option value="<?php echo set_value('cliente'); ?>">Seleccionar cliente</option>
                            <?php
                              ...
                              <option value="<?php echo $cheque[0]['cliente'];?>"
                                <?php if($clientes[$i]['id']==$cheque[0]['cliente']) echo 'selected="selected"'; ?>>
                    ...
                    <option value="<?php echo set_value('depositar_en'); ?>">Seleccionar cuenta</option>
                            <?php
                              ...
                              <option value="<?php echo $cuentas[$i]['id'];?>"
                                <?php if($cuentas[$i]['id']==$cheque[0]['depositar_en']) echo 'selected="selected"'; ?>>
