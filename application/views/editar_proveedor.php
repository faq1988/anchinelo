    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <!-- form start -->
            <!--form role="form"-->
            <?php echo form_open('Cheque/editar_proveedor/'. $proveedor[0]['id']); ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  value="<?php echo $proveedor[0]['nombre_apellido']; ?>">
                ...
                <div class="form-group">
                  ...
                  value="<?php echo $proveedor[0]['domicilio']; ?>">
                ...
                <div class="form-group">
                  ...
                  value="<?php echo $proveedor[0]['telefono']; ?>">
